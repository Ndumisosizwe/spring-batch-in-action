 ...
 */
@Component
public class XPBDataItemWriter implements ItemWriter<XPBCommissionStatementData> {

    private static final Logger LOG = LoggerFactory.getLogger(XPBDataItemWriter.class);

    @Override
    @Retryable
    public void write(List<? extends XPBCommissionStatementData> items) throws Exception {
